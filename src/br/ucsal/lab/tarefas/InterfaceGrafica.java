		...
		atualizar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (Tarefa tarefa : listaTarefas.getTarefas()) {
					...
					dado.add(tarefa.getTitulo());
					dado.add(tarefa.getDescricao());
					dado.add(tarefa.getConcluida()?"OK":tarefa instanceof TarefaPrazo ? tarefa.toString().substring(75).replace("-", "/").replace("[", "").replace("]", ""):tarefa instanceof TarefaEmail ? tarefa.toString():"");
					dados.add(dado);
				}
